...
public class ReportApiIntegrationTest extends BaseIntegrationTest {
    ...
    void testCreateAllocationSuccess() {
        ...
        Assertions.assertDoesNotThrow(() -> api.createAllocationReport(
                TEST_CLIENT_API_KEY, EMAIL_TO, LocalDate.now().minusDays(15), LocalDate.now().plusDays(15), ReportFormat.PDF.name()));
    }
