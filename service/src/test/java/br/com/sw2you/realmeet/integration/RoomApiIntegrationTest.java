...
public class RoomApiIntegrationTest extends BaseIntegrationTest {
    ...
    void testCreateRoomValidationError(){
        assertThrows(HttpClientErrorException.UnprocessableEntity.class, () -> api.createRoom(TEST_CLIENT_API_KEY, newCreateRoomDTO().name(null)));
    }
    ...
    void testUpdateRoomDoesNotExists() {
        assertThrows(HttpClientErrorException.NotFound.class,
                () -> api.updateRoom(TEST_CLIENT_API_KEY, 1L, new UpdateRoomDTO().name("Room A").seats(10)));
    }
