...
public class ReportCreationService {
    ...
    private void createReport(ReportHandlerType reportHandlerType, String email, String reportFormatStr, AllocationReportData reportData) {
        ...
        reportDispatcherService.dispatch(GeneratedReport
                .newBuilder()
                .bytes(bytes)
                .fileName(buildFileName(ALLOCATION, reportFormat))
